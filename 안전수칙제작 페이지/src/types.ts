...
export const INITIAL_POSTER_CONTENT: PosterContent = {
  ...
  coreActions: [
    { iconName: 'HardHat', title: '보호구 착용', description: '지정된 보호구를 반드시 착용합니다. (고무장갑, 보안경, Mask 등)' },
    { iconName: 'ShieldAlert', title: '얼굴 · 신체 노출 금지', description: 'Hood 개구면 주위에 흡입 방해물이 있는지 확인하고, 얼굴을 대지 않습니다.' },
    { iconName: 'Wrench', title: '작업 후 정리', description: '작업 후에는 손발을 깨끗이 씻고, 작업장 주위를 정리 · 정돈합니다.' },
  ],
  detailedRules: [
