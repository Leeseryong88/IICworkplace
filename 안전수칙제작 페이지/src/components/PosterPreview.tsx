...
import { IconName, PosterContent } from '../types';
...
export const PosterPreview = ({ content }: PosterPreviewProps) => {
  return (
    <div id="safety-poster" className="w-full max-w-[800px] mx-auto aspect-[3/4.2] bg-white p-[8%] flex flex-col gap-6 border-[1px] border-black overflow-hidden text-black leading-tight bg-white">
      {/* Top Header */}
      ...
      <div className="mt-4 border-b-[10px] border-black pb-6">
        ...
        <div className="mt-6 flex justify-between items-end">
          <p className="text-[1.2rem] font-black max-w-[70%]">
            {content.subTitle}
          </p>
      ...
      {/* Core Actions (3 pillars) - Editorial Style: Stacked or strictly gridded */}
          ...
          {content.coreActions.slice(0, 3).map((action, idx) => (
            <div key={idx} className="flex flex-col gap-3 text-center px-4">
              ...
              <div className="space-y-0.5">
                <h3 className="text-[1.1rem] font-[900] uppercase tracking-tighter leading-none mb-1">{action.title}</h3>
      ...
      {/* Detailed Rules (dynamic items) - High Density Grid */}
        ...
        <div className="grid grid-cols-2 gap-x-12 gap-y-4">
          {content.detailedRules.map((rule, idx) => (
            <div key={rule.id} className="flex items-start gap-4 py-2 border-b border-black/10">
              ...
              <p className="text-[0.7rem] font-black uppercase leading-tight">
                {rule.content}
              </p>
            </div>
          ))}
      ...
      <div className="mt-8 flex justify-between items-end border-t-2 border-black pt-4">
        ...
        <div className="text-[1.2rem] font-[900] tracking-tighter uppercase">
